...
$entries = array(
	...
	'Display options for the [zanjir_register] shortcode fields.' => 'گزینه‌های نمایش فیلدهای شورتکد [zanjir_register].',
	'Field labels'                                                => 'برچسب فیلدها',
	'Show a label above each registration field.'                 => 'نمایش برچسب بالای هر فیلد ثبت‌نام.',
	'Field placeholders'                                          => 'متن راهنمای فیلدها',
	'Show placeholder text inside each registration field.'       => 'نمایش متن راهنما داخل هر فیلد ثبت‌نام.',
	'Show'                                                        => 'نمایش',
	'Hide'                                                        => 'مخفی',
	...
	'Log in'                                                      => 'ورود',
	'Your affiliate registration is pending admin approval.'      => 'ثبت‌نام افیلیت شما در انتظار تأیید مدیر است.',
	'Your affiliate registration was rejected. Contact support if you need a review.' => 'ثبت‌نام افیلیت شما رد شده است. برای بررسی دوباره با پشتیبانی تماس بگیرید.',
	'Your affiliate account is suspended. Contact support for details.' => 'حساب افیلیت شما تعلیق شده است. برای جزئیات با پشتیبانی تماس بگیرید.',
	'You are already an approved affiliate.'                      => 'شما قبلاً به‌عنوان افیلیت تأییدشده ثبت شده‌اید.',
	'Go to dashboard'                                             => 'رفتن به داشبورد',
	'Go to registration'                                          => 'رفتن به ثبت‌نام',
	'No approved affiliate account is linked to this user. Dashboard data is only shown for approved affiliates.' => 'هیچ حساب افیلیت تأییدشده‌ای به این کاربر متصل نیست. داده‌های داشبورد فقط برای افیلیت‌های تأییدشده نمایش داده می‌شود.',
	'Affiliate pages'                                             => 'برگه‌های افیلیت',
	'Map WordPress pages used for registration and the dashboard access gate.' => 'برگه‌های وردپرس برای ثبت‌نام و گیت دسترسی داشبورد را مشخص کنید.',
	'Dashboard page'                                              => 'برگه داشبورد',
	'Guests and non-approved affiliates are redirected away from this page. Leave empty to disable the gate.' => 'مهمان‌ها و افیلیت‌های تأییدنشده از این برگه هدایت می‌شوند. برای خاموش کردن گیت خالی بگذارید.',
	'Registration page'                                           => 'برگه ثبت‌نام',
	'Public signup landing. Non-approved users hitting the dashboard are sent here.' => 'لندینگ عمومی ثبت‌نام. کاربران تأییدنشده که به داشبورد می‌آیند به اینجا فرستاده می‌شوند.',
	'Login page'                                                  => 'برگه ورود',
	'Page used for guest login links (e.g. SMS login / Voorodak account button). Falls back to WooCommerce My Account, then wp-login.' => 'برگه‌ای که لینک ورود مهمان به آن می‌رود (مثلاً ورود پیامکی / دکمه حساب Voorodak). در غیر این صورت حساب ووکامرس و سپس wp-login.',
	'— Select —'                                                  => '— انتخاب —',
	'Suspended'                                                   => 'تعلیق‌شده',
	'National ID'                                                 => 'کد ملی',
